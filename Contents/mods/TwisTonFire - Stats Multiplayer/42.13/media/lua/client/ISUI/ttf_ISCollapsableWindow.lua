...
ttf_ISCollapsableWindow = ISPanel:derive("ttf_ISCollapsableWindow");
--ttf_ISCollapsableWindow.viewList = {};
...
function ttf_ISCollapsableWindow:initialise()
	ISPanel.initialise(self);
end

function ttf_ISCollapsableWindow:setTitle(title)
	self.title = title;
end

function ttf_ISCollapsableWindow:getTitle()
	return self.title;
end
...
function ttf_ISCollapsableWindow:createChildren()
    ...
    self.infoButton = ISButton:new(1 + buttonHeight + buttonOffset, 1, buttonHeight, buttonHeight, "", self, ttf_ISCollapsableWindow.onInfo);
	...
	self.pinButton = ISButton:new(self.width - 1 - buttonHeight, 1, buttonHeight, buttonHeight, "", self, ttf_ISCollapsableWindow.pin);
	...
	self.collapseButton = ISButton:new(self.pinButton:getX(), 1, buttonHeight, buttonHeight, "", self, ttf_ISCollapsableWindow.collapse);
...
function ttf_ISCollapsableWindow:setInfo(text)
...
function ttf_ISCollapsableWindow:onInfo()
...
function ttf_ISCollapsableWindow:close()
	self:setVisible(false);
end

function ttf_ISCollapsableWindow:collapse()
	self.pin = false;
...
function ttf_ISCollapsableWindow:pin()
	self.pin = true;
...
function ttf_ISCollapsableWindow:prerender()
...
function ttf_ISCollapsableWindow:render()
...
--**
--************************************************************************--
function ttf_ISCollapsableWindow:onMouseMove(dx, dy)
	self.mouseOver = true;
...
function ttf_ISCollapsableWindow:uncollapse()
...
--**
--************************************************************************--
function ttf_ISCollapsableWindow:onMouseMoveOutside(dx, dy)
...
--**
--************************************************************************--
function ttf_ISCollapsableWindow:onMouseUp(x, y)
...
function ttf_ISCollapsableWindow:onMouseUpOutside(x, y)
	if not self:getIsVisible() then
		return;
	end
...
function ttf_ISCollapsableWindow:onMouseDown(x, y)
...
function ttf_ISCollapsableWindow:addView(view)
	view:setX(0);
...
function ttf_ISCollapsableWindow:getViews()
	return self.viewList;
end

function ttf_ISCollapsableWindow.TitleBarHeight()
...
function ttf_ISCollapsableWindow:resizeWidgetHeight()
	return (BUTTON_HGT/2)+2
end

function ttf_ISCollapsableWindow:setResizable(resizable)
...
function ttf_ISCollapsableWindow:RestoreLayout(name, layout)
...
function ttf_ISCollapsableWindow:SaveLayout(name, layout)
    ISLayoutManager.DefaultSaveWindow(self, layout)
    if self.pin then layout.pin = 'true' else layout.pin = 'false' end
end

function ttf_ISCollapsableWindow:setForceHidePinCollapse(b)
    self._forceHidePinCollapse = (b == true)
...
function ttf_ISCollapsableWindow:setDrawFrame(visible)
    self.background = visible
    self.drawFrame  = visible
    if self.closeButton then
        self.closeButton:setVisible(visible)
        if self._forceHidePinCollapse then
            if self.pinButton      then self.pinButton:setVisible(false)      end
            if self.collapseButton then self.collapseButton:setVisible(false) end
        else
            if self.pinButton      then self.pinButton:setVisible(visible and not self.pin) end
            if self.collapseButton then self.collapseButton:setVisible(visible and self.pin) end
        end
    end
end
...
--**
--************************************************************************--
function ttf_ISCollapsableWindow:new (x, y, width, height)
	local o = {}
	--o.data = {}
