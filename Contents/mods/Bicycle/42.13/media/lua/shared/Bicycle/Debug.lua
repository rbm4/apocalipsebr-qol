...
---Spawn a flat wheel into player 0's inventory for recipe testing.
---Call from the Lua console: BicycleDebug.spawnFlatWheel()
---Optionally pass a flat type: BicycleDebug.spawnFlatWheel("Bicycle.Bicycle_OffroadWheelRearFlatItem")
