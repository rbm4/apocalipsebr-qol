...
VehicleZoneDistribution.trailerpark.vehicles["Base.TrailerM101A3cargo"] = {index = -1, spawnChance = 0};
...
VehicleZoneDistribution.ranger.vehicles["Base.TrailerM101A3cargo"] = {index = -1, spawnChance = 0};
...
VehicleZoneDistribution.trafficjams.vehicles["Base.TrailerM101A3cargo"] = {index = -1, spawnChance = 0};
