...
BuildlMetalFence = ISBuildingObject:derive('BuildlMetalFence')


function BuildlMetalFence:create(x, y, z, north, sprite)
...
function BuildlMetalFence:addPart(x, y, z, north, sprite)
  local cell = getWorld():getCell()
  if not north then
...
function BuildlMetalFence:getHealth()
  return 200 + buildUtil.getWoodHealth(self)
end

function BuildlMetalFence:render(x, y, z, square)
...
function BuildlMetalFence:isValid(square)
...
function BuildlMetalFence:getSquare2Pos(square, north)
  local x = square:getX()
  local y = square:getY()
  local z = square:getZ()
  if north then
...
function BuildlMetalFence:new(sprite1, sprite2, northSprite1, northSprite2)
  local o = {}
  setmetatable(o, self)
  self.__index = self
  o:init()
