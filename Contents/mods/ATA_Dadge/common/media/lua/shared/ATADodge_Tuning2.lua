...
NewCarTuningTable["ATADodge"].parts["ATA2ProtectionWindowFrontRight"] = copy(
    NewCarTuningTable["ATADodge"].parts["ATA2ProtectionWindowFrontLeft"])
NewCarTuningTable["ATADodge"].parts["ATA2ProtectionWindowFrontRight"].Default.protection = {"WindowFrontRight"}
NewCarTuningTable["ATADodge"].parts["ATA2ProtectionWindowFrontRight"].Default.install.requireInstalled =
    {"WindowFrontRight"}
NewCarTuningTable["ATADodge"].parts["ATA2ProtectionWindowFrontRight"].Default.uninstall.requireUninstalled =
