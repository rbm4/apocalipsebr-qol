...
table.insert(ProceduralDistributions.list["GasStorageMechanics"].items, "Autotsar.ATADodgeTuningMag");
...
table.insert(ProceduralDistributions.list["LivingRoomSideTable"].items, "Autotsar.ATADodgeTuningMag");
table.insert(ProceduralDistributions.list["LivingRoomSideTable"].items, 0.03);
table.insert(ProceduralDistributions.list["LivingRoomSideTableNoRemote"].items, "Autotsar.ATADodgeTuningMag");
...
table.insert(ProceduralDistributions.list["MechanicSpecial"].items, "Autotsar.ATADodgeTuningMag");
