...
local function ModOptions() 
    ...
    AutoMechanics.OPTIONS.WaitCycles    = options:addSlider("4",  getText("UI_AutoMechanics_WaitCycles"), 0, 100, 1, 10, getText("UI_AutoMechanics_Tooltip_WaitCycles"))
...
function AutoMechanics.getWaitCycle()--TODO implement when MP comes
    return AutoMechanics.OPTIONS.WaitCycles and AutoMechanics.OPTIONS.WaitCycles:getValue()
end
...
function AutoMechanics.getVerboseClient()
