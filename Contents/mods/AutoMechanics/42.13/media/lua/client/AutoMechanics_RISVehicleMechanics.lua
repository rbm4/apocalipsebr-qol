...
function ISVehicleMechanics:addAutoMechanicsButtons()
    ...
    description = description .. AutoMechanics.getTooltipLine(self.chr, "Screwdriver", ItemTag.SCREWDRIVER)--tag
    description = description .. AutoMechanics.getTooltipLine(self.chr, "Wrench"     , ItemTag.WRENCH)--tag
    description = description .. AutoMechanics.getTooltipLine(self.chr, "LugWrench"  , ItemTag.LUG_WRENCH)--tag
